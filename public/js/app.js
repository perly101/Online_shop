...
window.PRODUCTS = [{
  ...
  price: 300.00,
  image: "bearbrand.jpg",
  description: "Rich and creamy powdered milk, fortified for everyday nutrition."
}, {
  id: 2,
  name: "Tanduay Select",
  price: 160.00,
  image: "tanduay select.jpg",
  description: "Premium distilled rum with a smooth finish — great for celebrations."
}, {
  id: 3,
  ...
  variants: [{
    flavor: "Barbecue",
    image: "barbecue piattos.jpg"
  }, {
    flavor: "Roast Beef",
    image: "roast beef piattos.jpg"
  }, {
    flavor: "Sour Cream",
    image: "sour cream piattos.jpg"
  }, {
    flavor: "Spicy Cheese",
    image: "spicy cheese piattos.jpg"
  }]
}, {
  id: 4,
  name: "Fudgee Bar",
  ...
  variants: [{
    flavor: "Chocolate",
    image: "chocolate fudgee bar.jpg"
  }, {
    flavor: "Milk",
    image: "milk fudgee bar.jpg"
  }, {
    flavor: "Vanilla",
    image: "vanilla fudgee bar.jpg"
  }, {
    flavor: "Red",
    image: "red fudgee bar.jpg"
  }, {
    flavor: "Durian",
    image: "durian  fudgee bar.jpg"
  }, {
    flavor: "Flavor Combo",
    image: "flavor combo fudgee bar.jpg"
  }]
}, {
  id: 5,
  name: "Coke mismo 290ml",
  price: 20.00,
  image: "coke mismo.jpg",
  description: "Refreshing cola in a convenient single-serve bottle."
}, {
  id: 6,
  name: "Pancit Canton",
  price: 18.00,
  ...
  variants: [{
    flavor: "Calamansi",
    image: "calamansi-pancit canton.jpg"
  }, {
    flavor: "Chilimansi",
    image: "chilimansi-pancit canton.jpg"
  }, {
    flavor: "Extra Hot",
    image: "extrahot-pancit canton.jpg"
  }, {
    flavor: "Sweet & Spicy",
    image: "sweet&spicy-pancit canton.jpg"
  }]
}, {
  id: 7,
  name: "Mega Sardines",
  price: 20.00,
  image: "mega sardines.jpg",
  description: "Tinned sardines in savory tomato sauce — a pantry essential."
}, {
  id: 8,
  name: "Closeup Toothpaste",
  price: 72.00,
  image: "closeup toothpaste.jpg",
  description: "Antibacterial toothpaste for fresh breath and healthy gums."
}, {
  id: 9,
  name: "Original Nescafe Twin",
  price: 150.00,
  image: "Original Nescafe Twin.jpg",
  description: "Instant coffee twin pack with rich aroma and a bold flavor."
}, {
  id: 10,
  name: "Safeguard 85g",
  price: 35.00,
  image: "safeguard 85g.jpg",
  description: "Trusted antibacterial soap for gentle, effective cleansing."
}, {
  id: 11,
  name: "Head & Shoulder",
  price: 77.00,
  image: "head & shoulder.jpg",
  description: "Anti-dandruff shampoo that cleanses and soothes the scalp."
}, {
  id: 12,
  name: "Surf 65g",
  price: 55.00,
  image: "surf 65g.jpg",
  description: "Concentrated detergent for powerful cleaning in small packs."
}, {
  id: 13,
  name: "Oishi Fish Crackers",
  price: 7.00,
  image: "fish crackers.jpg",
  description: "Crispy fish-flavored crackers with a savory taste — perfect for snacking anytime."
}, {
  id: 14,
  name: "Oishi Patata",
  price: 7.00,
  image: "patata.jpg",
  description: "Crunchy potato chips with a delightful flavor — a classic snack favorite."
}, {
  id: 15,
  name: "Oishi Rinbee",
  price: 7.00,
  image: "rinbee.jpg",
  description: "Light and crispy wheat crackers with a hint of sweetness — great for on-the-go snacking."
}, {
  id: 16,
  name: "Oishi Kirei",
  price: 7.00,
  image: "kirei.jpg",
  description: "Delicious seaweed crackers with a rich umami flavor — a healthy and tasty treat."
}, {
  id: 17,
  name: "Oishi Boogyman",
  price: 7.00,
  image: "boogyman.jpg",
  description: "Fun and flavorful snack crackers — perfect for kids and adults alike."
}, {
  id: 18,
  ...
  variants: [{
    flavor: "Labuyo",
    image: "luckey me-labuyo.jpg"
  }, {
    flavor: "Chicken",
    image: "luckey me-chicken.jpg"
  }, {
    flavor: "Beef",
    image: "luckey me-beef.jpg"
  }]
}, {
  id: 19,
  name: "Corned Beef",
  ...
  description: "Savory canned corned beef — ideal for quick meals and hearty recipes."
}];
...
var map = {
	...
	"./order-history": "../js/order-history.js",
	"./order-history.js": "../js/order-history.js",
	"./order-utils": "../js/order-utils.js",
	"./order-utils.js": "../js/order-utils.js",
	...
	"./signup": "../js/signup.js",
	"./signup.js": "../js/signup.js",
	"./user-detail": "../js/user-detail.js",
	"./user-detail.js": "../js/user-detail.js",
	"./user-management": "../js/user-management.js",
	"./user-management.js": "../js/user-management.js",
	"./user-type": "../js/user-type.js",
	"./user-type.js": "../js/user-type.js",
	"./utils": "../js/utils.js",
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var loggedInStaff = localStorage.getItem('loggedInStaff');
  if (!loggedInStaff) {
    // Redirect to Laravel login page if not logged in
  ...
  var orders = [];
  var storedOrders = localStorage.getItem('ordersData');
  ...
  if (storedOrders) {
    try {
      ...
      orders = [{
        ...
        total: 150,
        items: [{
          name: "Nescafe Original Twin pack 7 units",
          quantity: 1,
          price: 150
        }]
      }, {
  ...
  function calculateTotalSales() {
    ...
    var todaySales = orders.filter(function (order) {
      ...
      var isMatchingStatus = order.status === "Delivered" || order.status === "Complete";

      // Compare dates by checking if they're the same day
      var isToday = orderDate.getDate() === today.getDate() && orderDate.getMonth() === today.getMonth() && orderDate.getFullYear() === today.getFullYear();
      console.log('Order:', order.id, 'Status:', order.status, 'Date:', orderDateStr, 'Parsed Date:', orderDate, 'Is matching status:', isMatchingStatus, 'Is today:', isToday);
      return isMatchingStatus && isToday;
    }).reduce(function (sum, order) {
      return sum + order.total;
    }, 0);
    var weekSales = orders.filter(function (order) {
      // For Complete orders, use completionDate; for Delivered orders, use original date
      var orderDateStr;
      if (order.status === "Complete" && order.completionDate) {
        orderDateStr = order.completionDate;
      ...
      var orderDate = new Date(orderDateStr);
      var isMatchingStatus = order.status === "Delivered" || order.status === "Complete";
      var isInWeek = orderDate >= startOfWeek && orderDate <= today;
      console.log('Order:', order.id, 'Status:', order.status, 'Date:', orderDateStr, 'Parsed Date:', orderDate, 'Is matching status:', isMatchingStatus, 'Is in week:', isInWeek);
      return isMatchingStatus && isInWeek;
    }).reduce(function (sum, order) {
      return sum + order.total;
    }, 0);
    var monthSales = orders.filter(function (order) {
      // For Complete orders, use completionDate; for Delivered orders, use original date
      var orderDateStr;
      if (order.status === "Complete" && order.completionDate) {
        orderDateStr = order.completionDate;
      ...
      var orderDate = new Date(orderDateStr);
      var isMatchingStatus = order.status === "Delivered" || order.status === "Complete";
      var isInMonth = orderDate >= startOfMonth && orderDate <= today;
      console.log('Order:', order.id, 'Status:', order.status, 'Date:', orderDateStr, 'Parsed Date:', orderDate, 'Is matching status:', isMatchingStatus, 'Is in month:', isInMonth);
  ...
  function calculateAverageRating() {
    ...
    var totalRating = customerFeedback.reduce(function (sum, feedback) {
  ...
  function renderAnalyticsData() {
    // Update total sales
    var salesData = calculateTotalSales();
    console.log('Calculated sales data:', salesData);
    var totalSalesElement = document.getElementById('total-sales');
    if (totalSalesElement) {
      totalSalesElement.innerHTML = "\n                <div class=\"sales-breakdown\">\n                    <div class=\"sales-item\">Today: \u20B1".concat(salesData.today.toLocaleString(), "</div>\n                    <div class=\"sales-item\">This Week: \u20B1").concat(salesData.week.toLocaleString(), "</div>\n                    <div class=\"sales-item\">This Month: \u20B1").concat(salesData.month.toLocaleString(), "</div>\n                </div>\n            ");
    }

    // Update total orders
    var totalOrdersElement = document.getElementById('total-orders');
    if (totalOrdersElement) {
      totalOrdersElement.textContent = calculateTotalOrders();
    }

    // Update pending orders
    var pendingOrdersElement = document.getElementById('pending-orders');
    if (pendingOrdersElement) {
      pendingOrdersElement.textContent = calculatePendingOrders();
    }

    // Update average rating
    var avgRatingElement = document.getElementById('avg-rating');
    if (avgRatingElement) {
  ...
  function renderPopularProducts() {
    var productList = document.getElementById('popular-products-list');
    var popularCount = document.getElementById('popular-count');
    if (productList && popularCount) {
      productList.innerHTML = '';
      popularCount.textContent = popularProducts.length;
      popularProducts.forEach(function (product, index) {
        var productItem = document.createElement('div');
        productItem.className = 'product-item';
        productItem.innerHTML = "\n                    <span class=\"product-item-rank\">#".concat(index + 1, "</span>\n                    <span class=\"product-item-name\">").concat(product.name, "</span>\n                    <span class=\"product-item-sold\">").concat(product.sold, " sold</span>\n                ");
  ...
  function renderCustomerFeedback() {
    ...
    if (feedbackList) {
      ...
      customerFeedback.forEach(function (feedback) {
        ...
        feedbackItem.innerHTML = "\n                    <div class=\"feedback-header\">\n                        <div class=\"feedback-user\">".concat(feedback.user, "</div>\n                        <div class=\"feedback-date\">Received: ").concat(feedback.date, "</div>\n                    </div>\n                    <div class=\"feedback-text\">").concat(feedback.feedback, "</div>\n                    <div class=\"feedback-stars\">").concat(starsHTML, "</div>\n                ");
  ...
  var totalSalesCard = document.getElementById('total-sales-card');
  if (totalSalesCard) {
  ...
  function showSalesBreakdownPopup() {
    ...
    var salesModal = document.getElementById('sales-breakdown-modal');
    if (!salesModal) {
  ...
  setInterval(function () {
    ...
    if (storedOrders) {
      try {
        var parsedOrders = JSON.parse(storedOrders);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var orderIdInput = document.getElementById('order-id'); // Changed from 'order-search'
  var searchIcon = document.getElementById('search-icon');
  var searchBtn = document.querySelector('.search-btn');
  var verificationOrderIdInput = document.getElementById('order-id-verification');
  ...
  function renderOrders() {
    ...
    ordersData.forEach(function (order, index) {
      ...
      orderItem.innerHTML = "\n                <div class=\"order-detail\">\n                    <strong>Order ID:</strong> ".concat(order.id, "\n                </div>\n                <div class=\"order-detail\">\n                    <strong>Customer:</strong> ").concat(order.customerEmail, "\n                </div>\n                <div class=\"order-detail\">\n                    <strong>Total:</strong> \u20B1").concat(order.total.toLocaleString(), "\n                </div>\n                <div class=\"order-detail\">\n                    <strong>Placed At:</strong> ").concat(order.date, ", ").concat(order.time, "\n                </div>\n                <div class=\"order-actions\">\n                    <a href=\"#\" class=\"view-orders-btn\" data-order-id=\"").concat(order.id, "\">View Orders</a>\n                    <div class=\"update-status\">\n                        <span>Update Status:</span>\n                        <select class=\"status-dropdown\" data-order-id=\"").concat(order.id, "\">\n                            <option value=\"Processing\" ").concat(order.status === 'Processing' ? 'selected' : '', ">Processing</option>\n                            <option value=\"Pending\" ").concat(order.status === 'Pending' ? 'selected' : '', ">Pending</option>\n                            <option value=\"Ready for Pickup\" ").concat(order.status === 'Ready for Pickup' ? 'selected' : '', ">Ready for Pickup</option>\n                            <option value=\"Complete\" ").concat(order.status === 'Complete' ? 'selected' : '', ">Complete</option>\n                            <option value=\"Cancel\" ").concat(order.status === 'Cancel' ? 'selected' : '', ">Cancel</option>\n                        </select>\n                    </div>\n                </div>\n            ");
    ...
    document.querySelectorAll('.status-dropdown').forEach(function (dropdown) {
      dropdown.addEventListener('change', function (e) {
        ...
        if (orderId) {
          ...
          if (order) {
            var orderIndex = ordersData.findIndex(function (o) {
              return o.id === orderId;
            });
  ...
  function filterOrders(searchTerm) {
    ...
    var normalizedSearch = searchTerm.trim().toUpperCase();

    // Create a copy of ordersData to avoid modifying the original
    var ordersCopy = _toConsumableArray(ordersData);

    // Sort orders to prioritize matches
    ordersCopy.sort(function (a, b) {
      var idA = a.id.toUpperCase();
      var idB = b.id.toUpperCase();

      // Check for exact matches
      var isExactMatchA = idA === normalizedSearch;
      var isExactMatchB = idB === normalizedSearch;
      ...
      var isPartialMatchA = idA.includes(normalizedSearch);
      var isPartialMatchB = idB.includes(normalizedSearch);
    ...
    var filteredOrders = ordersCopy.filter(function (order) {
      var orderIdStr = order.id.toString().toUpperCase();
  ...
  function showStatusChangeConfirmation(order, index, newStatus) {
    ...
    var messageElement = notificationModal.querySelector('#status-message');
    switch (newStatus) {
      case 'Ready for Pickup':
        messageElement.textContent = "Your order #".concat(order.id, " is ready for pick-up");
        break;
      case 'Cancel':
        messageElement.textContent = "Your order #".concat(order.id, " is cancelled");
        break;
      case 'Processing':
        messageElement.textContent = "Your order #".concat(order.id, " is now on processing");
        break;
      case 'Pending':
        messageElement.textContent = "Your order #".concat(order.id, " is in pending");
        break;
      case 'Complete':
        messageElement.textContent = "Your order #".concat(order.id, " is successfully received!");
        break;
      default:
        messageElement.textContent = "Your order #".concat(order.id, " status changed to ").concat(newStatus);
    }

    // Remove existing event listeners to avoid duplicates
    var cancelBtn = document.getElementById('cancel-notification-send');
    var sendBtn = document.getElementById('send-notification-to-customer');

    // Create new event listeners
    var _cancelHandler = function cancelHandler() {
      notificationModal.style.display = 'none';
      document.body.style.overflow = 'auto'; // Restore scrolling
      // Reset the dropdown to the previous value
      var dropdown = document.querySelector(".status-dropdown[data-order-id=\"".concat(order.id, "\"]"));
      if (dropdown) {
    ...
    var _sendHandler = function sendHandler() {
  ...
  function sendNotificationForStatusChange(order, newStatus) {
    ...
    try {
      ...
      switch (newStatus) {
        case 'Ready for Pickup':
          message = "Your order ".concat(order.id, " is ready for pickup! Please proceed to the store.");
          break;
        case 'Cancel':
          message = "Your order ".concat(order.id, " has been cancelled.");
          break;
        case 'Processing':
          message = "Your order ".concat(order.id, " is now being processed.");
          break;
        case 'Pending':
          message = "Your order ".concat(order.id, " is now pending.");
          break;
        case 'Complete':
          message = "Your order ".concat(order.id, " has been successfully completed!");
          break;
        default:
          message = "Your order ".concat(order.id, " status has been updated to: ").concat(newStatus);
      }
      ...
      var type = newStatus === 'Complete' || newStatus === 'Ready for Pickup' ? 'success' : newStatus === 'Cancel' ? 'warning' : 'info';
      var notif = {
        id: Date.now(),
        orderId: order.id,
        message: message,
    ...
    // Log for debugging
    console.log("Notification stored for customer ".concat(order.customerEmail, " for order status change to: ").concat(newStatus));
  }
  ...
  function sendNotificationToCustomer(order) {
    ...
    console.log("Notification sent to customer for order: ".concat(order.customerEmail));
  ...
  function showOrderDetails(order) {
    ...
    var formattedDate = formatDate(order.date);
    var formattedTime = formatTime(order.time);
    document.getElementById('modal-date').textContent = formattedDate;
    document.getElementById('modal-time').textContent = formattedTime;

    // Update total price
    document.getElementById('modal-total-price').textContent = "Php. ".concat(order.total.toLocaleString());

    // Clear and populate items list
    var itemsList = document.getElementById('modal-items-list');
    itemsList.innerHTML = '';
    order.items.forEach(function (item) {
      // Use placeholder if no image provided
      var imgSrc = item.image || 'image/placeholder.png';
      var itemPrice = (item.price * item.quantity).toLocaleString();
      ...
      priceDiv.innerHTML = "\n                <span class=\"quantity\">x".concat(item.quantity, "</span>\n                <span class=\"price\">Php.").concat(itemPrice, "</span>\n            ");
  ...
  function updateOrderBadge() {
    var badgeElements = document.querySelectorAll('.badge');
    var orderCount = ordersData.length;
    badgeElements.forEach(function (badge) {
      badge.textContent = orderCount;
    });
  }
  ...
  setTimeout(function () {
    ...
    if (verificationOrderIdInput) {
      ...
      verificationOrderIdInput.addEventListener('input', function (e) {
        filterOrders(e.target.value);
      });

      // Search when pressing Enter key in verification input
      verificationOrderIdInput.addEventListener('keypress', function (e) {
        if (e.key === 'Enter') {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var displayedProducts = 10; // Number of products to display initially
  ...
  var editProductSection = document.getElementById('edit-product-section');
  ...
  var editProductNameInput = document.getElementById('edit-product-name');
  var editProductPriceInput = document.getElementById('edit-product-price');
  var editProductStockInput = document.getElementById('edit-product-stock');
  var editProductImageInput = document.getElementById('edit-product-image');
  ...
  function updateProductCount() {
    productCount.textContent = "(".concat(products.length, ")");
  }
   ...
   */
  productImageInput.addEventListener('change', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var file, container, label, _container, _label, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            imagePreviewUrl = _context.v;
            // Hide the label and show the preview
            container = imagePreview.parentElement; // image-upload-container
            label = container.querySelector('.image-upload-label');
            if (label) {
              label.style.display = 'none';
            }
            imagePreview.innerHTML = "<div class=\"preview-wrapper\"><img src=\"".concat(imagePreviewUrl, "\" alt=\"Preview\" class=\"preview-image\"></div>");
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            console.error('Error reading image:', _t);
          ...
          case 5:
            ...
            _container = imagePreview.parentElement; // image-upload-container
            _label = _container.querySelector('.image-upload-label');
            if (_label) {
   ...
   */
  editProductImageInput.addEventListener('change', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var file, container, label, _container2, _label2, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            return fileToDataURL(file);
          case 2:
            editImagePreviewUrl = _context2.v;
            // Hide the label and show the preview
            container = editImagePreview.parentElement; // image-upload-container
            label = container.querySelector('.image-upload-label');
            if (label) {
              label.style.display = 'none';
            }
            editImagePreview.innerHTML = "<div class=\"preview-wrapper\"><img src=\"".concat(editImagePreviewUrl, "\" alt=\"Preview\" class=\"preview-image\"></div>");
          ...
          case 3:
            _context2.p = 3;
            _t2 = _context2.v;
            console.error('Error reading image:', _t2);
            showPopup('Error loading image. Please try again.');
          case 4:
            _context2.n = 6;
            break;
          case 5:
            ...
            // Show the label again
            _container2 = editImagePreview.parentElement; // image-upload-container
            _label2 = _container2.querySelector('.image-upload-label');
            if (_label2) {
              _label2.style.display = 'flex';
            }
  ...
  function renderProducts() {
    ...
    var productsToShow = products.slice(0, displayedProducts);
    productsToShow.forEach(function (product) {
      var row = document.createElement('tr');
      row.innerHTML = "\n                <td class=\"product-name\">".concat(product.name, "</td>\n                <td class=\"product-price\">").concat(product.price, "</td>\n                <td class=\"product-stock\">").concat(product.stock, "</td>\n                <td class=\"product-image-cell\">\n                    <img src=\"").concat(product.image, "\" alt=\"").concat(product.name, "\" onerror=\"this.src='https://via.placeholder.com/50x70/CCCCCC/666666?text=No+Image'\" style=\"width:50px; height:70px; object-fit:contain; display:block; margin:0 auto; box-sizing:border-box;\">\n                </td>\n                <td>\n                    <div class=\"product-actions\">\n                        <button class=\"action-btn edit-btn\" data-product-id=\"").concat(product.id, "\" title=\"Edit\">\n                            <i class=\"fas fa-edit\"></i>\n                        </button>\n                        <button class=\"action-btn delete-btn\" data-product-id=\"").concat(product.id, "\" title=\"Delete\">\n                            <i class=\"fas fa-trash\"></i>\n                        </button>\n                    </div>\n                </td>\n            ");
  ...
  function attachProductActionListeners() {
    ...
    document.querySelectorAll('.edit-btn').forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        var productId = parseInt(e.currentTarget.getAttribute('data-product-id'));
  ...
  function resetAddProductForm() {
    ...
    imagePreview.style.display = 'none';
    // Show the label again
    var container = imagePreview.parentElement; // image-upload-container
    var label = container.querySelector('.image-upload-label');
    if (label) {
  ...
  function resetEditProductForm() {
    ...
    editImagePreview.style.display = 'none';
    // Show the label again
    var container = editImagePreview.parentElement; // image-upload-container
    var label = container.querySelector('.image-upload-label');
    if (label) {
      label.style.display = 'flex';
    }
  ...
  function addProduct() {
    ...
    var stock = parseInt(productStockInput.value);
    var image = imagePreviewUrl || 'https://via.placeholder.com/50x70/CCCCCC/666666?text=No+Image';
  ...
  function editProduct(productId) {
    ...
    editImagePreview.innerHTML = "<div class=\"preview-wrapper\"><img src=\"".concat(product.image, "\" alt=\"").concat(product.name, "\" class=\"preview-image\"></div>");
    editImagePreview.style.display = 'flex';
    ...
    editProductSection.scrollIntoView({
      behavior: 'smooth',
      block: 'nearest'
    });
  }
  ...
  function saveProductChanges() {
    ...
    if (!product) return;
    var name = editProductNameInput.value.trim();
    var price = parseFloat(editProductPriceInput.value);
    var stock = parseInt(editProductStockInput.value);
    var image = editImagePreviewUrl || product.image;
  ...
  function renderFilteredProducts(filteredProducts) {
    ...
    filteredProducts.forEach(function (product) {
      var row = document.createElement('tr');
      row.innerHTML = "\n                <td>\n                    <div class=\"product-name\">".concat(product.name, "</div>\n                </td>\n                <td>\n                    <div class=\"product-price\">\u20B1").concat(product.price.toLocaleString(), "</div>\n                </td>\n                <td>\n                    <div class=\"product-stock\">").concat(product.stock, "</div>\n                </td>\n                <td>\n                    <div class=\"product-image-cell\">\n                        <img src=\"").concat(product.image, "\" alt=\"").concat(product.name, "\" onerror=\"this.src='https://via.placeholder.com/50x70/CCCCCC/FFFFFF?text=No+Image'\">\n                    </div>\n                </td>\n                <td>\n                    <div class=\"product-actions\">\n                        <button class=\"action-btn edit-btn\" data-product-id=\"").concat(product.id, "\">\n                            <i class=\"fas fa-edit\"></i>\n                        </button>\n                        <button class=\"action-btn delete-btn\" data-product-id=\"").concat(product.id, "\">\n                            <i class=\"fas fa-trash\"></i>\n                        </button>\n                    </div>\n                </td>\n            ");
      productTableBody.appendChild(row);
    });
  ...
  function loadProductsFromLocalStorage() {
    var storedProducts = localStorage.getItem('inventoryProducts');
    if (storedProducts) {
      try {
        products = JSON.parse(storedProducts);
        // Update nextProductId to be higher than the highest existing ID
        var maxId = Math.max.apply(Math, _toConsumableArray(products.map(function (p) {
          return p.id;
        })).concat([0]));
  ...
  productStockInput.addEventListener('keypress', function (e) {
    if (e.key === 'Enter') addProduct();
  });
  ...
  editProductNameInput.addEventListener('keypress', function (e) {
    if (e.key === 'Enter') saveProductChanges();
  });
  editProductPriceInput.addEventListener('keypress', function (e) {
    if (e.key === 'Enter') saveProductChanges();
  });
  editProductStockInput.addEventListener('keypress', function (e) {
    if (e.key === 'Enter') saveProductChanges();
  });
...
if (typeof window.handleLogin === 'undefined') {
  window.handleLogin = function (event) {
    ...
    if (matched) {
      // set unified currentUser with full user data and redirect to Laravel shop
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  buildings.forEach(function (building, index) {
    building.style.animation = "float ".concat(3 + index, "s ease-in-out infinite");
  });
});
...
(function () {
  ...
  function updateNotificationDot() {
    ...
    if (!dot) return;
    var unreadCount = OrderUtils.getUnreadCount();
    if (unreadCount > 0) {
  ...
  function renderNotifications() {
    ...
    notifications.forEach(function (notif) {
      ...
      var iconClass = notif.type === 'success' ? 'success' : 'info';
      var iconSymbol = notif.type === 'success' ? '✓' : 'ℹ';
      li.innerHTML = "\n        <div class=\"notification-icon ".concat(iconClass, "\">").concat(iconSymbol, "</div>\n        <div class=\"notification-content\">\n          <div class=\"notification-message\">").concat(notif.message, "</div>\n          <div class=\"notification-time\">").concat(formatTime(notif.createdAt), "</div>\n        </div>\n        <button class=\"notification-delete-btn\" data-id=\"").concat(notif.id, "\" title=\"Delete notification\">\n          <i class=\"fas fa-times\"></i>\n        </button>\n      ");
      ...
      li.addEventListener('click', function (event) {
        ...
        if (notif.orderId) {
          ...
          var orderIdMatch = notif.message.match(/Your order ([^ ]+)/);
      ...
      setTimeout(function () {
        var deleteBtn = li.querySelector('.notification-delete-btn');
        if (deleteBtn) {
          deleteBtn.addEventListener('click', function (event) {
            event.stopPropagation(); // Prevent the notification click event
            var notificationId = parseInt(deleteBtn.getAttribute('data-id'));
  ...
  function showOrderQRCode(orderId) {
    ...
    if (!order) {
      ...
      order = orders.find(function (o) {
        return String(o.id) === String(orderId).replace('#', '');
      });
    }
    if (!order) {
      // Try with # prefix
    ...
    if (!order) {
      ...
      var orderIdPart = String(orderId).split('-').pop();
      order = orders.find(function (o) {
        var orderIdToCheck = String(o.id);
  ...
  function showQRCodeModal(orderId, order) {
    ...
    orderIdElement.textContent = "Order ID: ".concat(orderId);
  ...
  function initNotifications() {
    ...
    var messagesIcon = document.getElementById('messagesIcon');
    var closeBtn = document.getElementById('notificationsClose');
    var markAllBtn = document.getElementById('markAllReadBtn');
    var overlay = document.getElementById('notificationsOverlay');
    ...
    document.addEventListener('keydown', function (e) {
      if (e.key === 'Escape') {
        var _overlay = document.getElementById('notificationsOverlay');
        if (_overlay && _overlay.classList.contains('active')) {
          closeNotifications();
        }
      }
    });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // DOM ELEMENTS
  // ============================================
  var orderHistoryList = document.getElementById('order-history-list');
  ...
  function formatCurrency(amount) {
    return "Php.".concat(amount.toLocaleString());
  }
  ...
  function renderOrderHistory() {
    ...
    orders.forEach(function (order) {
      ...
      var statusClass = order.status === 'Delivered' ? 'status-delivered' : 'status-canceled';
      item.innerHTML = "\n                <div class=\"order-history-left\">\n                    <div class=\"order-history-id\">".concat(order.id, "</div>\n                    <div class=\"order-history-date\">").concat(order.date, "</div>\n                    <div class=\"order-history-time\">").concat(order.time, "</div>\n                </div>\n                <div class=\"order-history-right\">\n                    <span class=\"order-history-status ").concat(statusClass, "\">").concat(order.status, "</span>\n                    <span class=\"order-history-view\" data-order-id=\"").concat(order.id, "\">View Details</span>\n                    <div class=\"order-history-price\">").concat(formatCurrency(order.price), "</div>\n                </div>\n            ");

      // Add click handler for "View Details"
      var viewDetailsBtn = item.querySelector('.order-history-view');
      viewDetailsBtn.addEventListener('click', function () {
        // Navigate to order detail or show modal
        showPopup("Viewing details for Order ".concat(order.id));
      });
...
(function (window) {
  ...
  function getCurrentUserId() {
    try {
      var currentUserRaw = localStorage.getItem('currentUser');
      if (currentUserRaw) {
  ...
  function generateOrderId() {
    ...
    try {
      ...
      if (ordersRaw) {
        ...
        var yearPrefix = "AET-".concat(year, "-");
        orders.forEach(function (order) {
          ...
          if (orderId.includes(yearPrefix)) {
            ...
            var match = orderId.match(new RegExp(yearPrefix + '(\\d+)'));
            if (match) {
    ...
    var sequenceStr = String(sequence).padStart(3, '0');
    return "#AET-".concat(year, "-").concat(sequenceStr);
  }
  ...
  function getLastPlacedOrder() {
    try {
      var lastOrderRaw = localStorage.getItem('lastPlacedOrder');
      if (lastOrderRaw) {
  ...
  function getUserNotificationsKey() {
    return "notifications_".concat(getCurrentUserId());
  }
  ...
  function createNotification(orderId, message, type) {
    try {
      var userNotificationsKey = getUserNotificationsKey();
      var notifications = JSON.parse(localStorage.getItem(userNotificationsKey) || '[]');
      var notification = {
        id: Date.now(),
        orderId: orderId,
        message: message,
  ...
  function notifyOrderReady(orderId, orderDetails) {
    var message = "Your order ".concat(orderId, " is now ready for pickup! Please proceed to the store.");
  ...
  function checkOrderStatusChanges() {
    try {
      var orders = JSON.parse(localStorage.getItem('orders') || '[]');
      var lastCheckKey = 'lastOrderStatusCheck';
      var lastCheck = localStorage.getItem(lastCheckKey) || '{}';
      var lastStatusMap = JSON.parse(lastCheck);
      orders.forEach(function (order) {
        var orderId = String(order.id || '');
        var currentStatus = order.status || 'placed';
        var lastStatus = lastStatusMap[orderId] || 'placed';
...
function checkLoginStatus() {
  ...
  if (currentUser) {
    ...
    showMessage("Welcome back, ".concat(user.email, "!"), 'success');
  }
}
...
function showShopNow() {
  ...
  // Redirect to the Laravel shop page
  window.location.href = '/shop';
}
...
function showMessage(text) {
  ...
  var existingMessages = container.querySelectorAll('.message');
...
document.addEventListener('keydown', function (event) {
  ...
  if (event.key === 'Enter' && currentPage) {
    var form = document.querySelector('.page.active form');
    if (form) {
...
if (typeof handleSignup !== 'undefined' && typeof window.__enhanced_handleSignup === 'undefined') {
  var originalHandleSignup = handleSignup;
  window.__enhanced_handleSignup = true;
  window.handleSignup = function (event) {
    var button = event.target.querySelector('.submit-btn');
    var removeLoading = addLoadingState(button);
    setTimeout(function () {
...
if (typeof handleLogin !== 'undefined' && typeof window.__enhanced_handleLogin === 'undefined') {
  var originalHandleLogin = handleLogin;
  window.__enhanced_handleLogin = true;
  window.handleLogin = function (event) {
    var button = event.target.querySelector('.submit-btn');
    var removeLoading = addLoadingState(button);
    setTimeout(function () {
...
function manageFormFocus() {
  ...
  if (activePage) {
    var firstInput = activePage.querySelector('input');
    if (firstInput) {
      firstInput.focus();
    }
  }
...
if (typeof showLoginPage !== 'undefined' && typeof window.__enhanced_showLoginPage === 'undefined') {
  var originalShowLoginPage = showLoginPage;
  window.__enhanced_showLoginPage = true;
  window.showLoginPage = function () {
    originalShowLoginPage();
    setTimeout(manageFormFocus, 100);
  };
}
if (typeof showCreateAccountPage !== 'undefined' && typeof window.__enhanced_showCreateAccountPage === 'undefined') {
  var originalShowCreateAccountPage = showCreateAccountPage;
  window.__enhanced_showCreateAccountPage = true;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Add button animations
  var createBtn = document.querySelector('.create-account-btn');
  if (createBtn) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadCustomersFromLocalStorage() {
    var storedCustomers = localStorage.getItem('adminCustomers');
    if (storedCustomers) {
      try {
  ...
  // ============================================
  var urlParams = new URLSearchParams(window.location.search);
  var selectedCustomerId = urlParams.get('id') || 'ADMIN001';

  // ============================================
  // DOM ELEMENTS
  // ============================================
  var customerList = document.getElementById('customer-list');
  var userDetailPanel = document.getElementById('user-detail-panel');
  var userName = document.getElementById('user-name');
  var userEmail = document.getElementById('user-email');
  var userTotalSpent = document.getElementById('user-total-spent');
  var changePasswordBtn = document.getElementById('change-password-btn');
  var addUserBtn = document.getElementById('add-user-btn');
  var deleteAccountBtn = document.querySelector('.accounts-actions .action-icon-btn'); // The delete button is now the first (and only) button
  ...
  var cancelChangePassword = document.getElementById('cancel-change-password');
  ...
  function renderCustomerList() {
    ...
    customers.forEach(function (customer) {
      var item = document.createElement('div');
      item.className = "customer-list-item ".concat(customer.id == selectedCustomerId ? 'active' : '');
      item.innerHTML = "\n                <span class=\"customer-id\">".concat(customer.id, "</span>\n                <span>").concat(customer.computerNumber, "</span>\n                <span class=\"status-").concat(customer.status.toLowerCase(), "\">").concat(customer.status, "</span>\n                <span>").concat(customer.password, "</span>\n            ");
  ...
  function updateUserDetail() {
    ...
    userEmail.textContent = "Computer #".concat(customer.computerNumber);
    userTotalSpent.textContent = "Status: ".concat(customer.status);
  ...
  function addUser(event) {
    ...
    var computerNumberInput = document.getElementById('new-user-computer-number').value;
    var computerNumber = parseInt(computerNumberInput) || 0;
    var password = document.getElementById('new-user-password').value;
    var status = 'Enter ID'; // Default status
    ...
    var compNumberToCheck = Number(computerNumber);
    if (customers.some(function (customer) {
      return Number(customer.computerNumber) === compNumberToCheck;
    })) {
    ...
    if (duplicates.length > 0) {
      ...
      if (duplicates.length === 1) {
        message = "".concat(duplicates[0], " already exists. Please use a unique ").concat(duplicates[0].toLowerCase(), ".");
      } else if (duplicates.length === 2) {
        message = "".concat(duplicates[0], " and ").concat(duplicates[1], " already exist. Please use unique values.");
      } else {
        message = "".concat(duplicates[0], ", ").concat(duplicates[1], ", and ").concat(duplicates[2], " already exist. Please use unique values.");
      }
      showPopup(message);
      return;
    }
  ...
  function deleteAccount() {
    ...
    if (loggedInStaff) {
      try {
        var staff = JSON.parse(loggedInStaff);
    ...
    showConfirm("Are you sure you want to delete account ".concat(customer.id, "?"), function () {
      // Remove the customer
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var customers = [];
  var savedCustomers = localStorage.getItem('adminCustomers');
  if (savedCustomers) {
  ...
  function renderCustomers() {
    ...
    filteredCustomers.forEach(function (customer) {
      var row = document.createElement('tr');
      row.innerHTML = "\n                <td></td>\n                <td class=\"customer-id\">".concat(customer.id, "</td>\n                <td class=\"computer-number\">").concat(customer.computerNumber, "</td>\n                <td class=\"status-cell\"><span class=\"status-").concat(customer.status.toLowerCase(), "\">").concat(customer.status, "</span></td>\n                <td class=\"password-cell\">").concat(customer.password, "</td>\n            ");

      // Add click handler for row
      row.addEventListener('click', function (e) {
        window.location.href = "user-detail.html?id=".concat(customer.id);
      });
  ...
  function filterCustomers(searchTerm) {
    if (!searchTerm.trim()) {
      filteredCustomers = _toConsumableArray(customers);
    } else {
      filteredCustomers = customers.filter(function (customer) {
        var search = searchTerm.toLowerCase();
        return customer.id.toLowerCase().includes(search) || customer.status.toLowerCase().includes(search);
      });
    }
    renderCustomers();
  }
...
function showPopup(message) {
  ...
  var buttonsContainer = document.getElementById('popup-buttons-container');
  var closeBtn = document.getElementById('popup-close-btn');
...
function showConfirm(message, onConfirm, onCancel) {
  var showCloseButton = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  // Ensure popup is initialized
  if (!popupInitialized) {
    initializePopup();
  }
  ...
  var okButton = document.getElementById('popup-ok-btn');
  if (popup && popupMessage) {
    ...
    if (cancelButton) {
      ...
      var cancelHandler = handleCancelClick(onCancel);
    ...
    if (okButton) {
      ...
      var okHandler = handleOkClick(onConfirm);
...
// Bootstrap / vendor setup
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");

// Consolidated legacy site scripts (loaded in safe order). Paths are relative to this file.
// These modules are written to be resilient to missing DOM elements, so bundling them
// globally is safe. Keep order: utilities, order utils, UI components, pages.
try {
  __webpack_require__(/*! ../../../js/utils.js */ "../js/utils.js");
} catch (e) {
  console.warn('utils.js not found during build:', e.message);
}
try {
  __webpack_require__(/*! ../../../js/order-utils.js */ "../js/order-utils.js");
} catch (e) {
  console.warn('order-utils.js not found during build:', e.message);
}

// UI components
['qrcode.min.js', 'notifications.js', 'sidebar.js', 'main.js', 'script.js'].forEach(function (f) {
  try {
    __webpack_require__("../js sync recursive ^\\.\\/.*$")("./".concat(f));
  } catch (e) {
    console.warn("".concat(f, " not included:"), e.message);
  }
});

// Page-specific scripts (optional)
['index.js', 'inventory.js', 'analytics.js', 'login.js', 'signup.js', 'user-type.js', 'user-management.js', 'user-detail.js', 'order-history.js'].forEach(function (f) {
  try {
    __webpack_require__("../js sync recursive ^\\.\\/.*$")("./".concat(f));
  } catch (e) {
    console.warn("".concat(f, " not included:"), e.message);
...
// Optional data file used by legacy static pages
try {
  __webpack_require__(/*! ../../../data/products.js */ "../data/products.js");
} catch (e) {
  console.warn('products data not found:', e.message);
}

// If Laravel provided an authenticated user on the server, mirror it into localStorage
// so existing client-side checks (from legacy code) continue to work without forcing
// users back to static login pages.
if (typeof window.serverUser !== 'undefined' && window.serverUser) {
  try {
    localStorage.setItem('currentUser', JSON.stringify(window.serverUser));
    console.log('Client: mirrored server user to localStorage');
  } catch (e) {
    console.warn('Failed to set currentUser from serverUser', e);
  }
}
